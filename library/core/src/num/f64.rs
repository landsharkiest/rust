...
pub mod math {
    ...
    ///
    /// This is the same operation as `intrinsics::fmuladdf64`, also known as
    ...
    #[must_use = "method returns a new number and does not mutate the original value"]
    pub const fn mul_add_relaxed(self, multiplicand: f64, addend: f64) -> f64 {
        intrinsics::fmuladdf64(self, multiplicand, addend)
    }
